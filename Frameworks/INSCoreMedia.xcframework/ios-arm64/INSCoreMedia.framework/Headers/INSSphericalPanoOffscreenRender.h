//
//  INSSphericalPanoOffscreenRender.h
//  INSCoreMedia
//
...
@interface INSSphericalPanoOffscreenRender : INSOffscreenRender
...
- (instancetype) initCenterCircleWithWidth:(int)width height:(int)height  minEdge:(int)minEdge multipleSample:(BOOL)multipleSample context:(EAGLContext*)context;
